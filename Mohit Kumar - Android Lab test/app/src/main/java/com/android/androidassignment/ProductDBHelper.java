...
public class ProductDBHelper extends SQLiteOpenHelper {
    ...
    public Product getProductbyID(int id) {
        ...
        if(result!=null)
        {
            ...
            product = new Product(result.getInt(result.getColumnIndex(column_id)),result.getString(result.getColumnIndex(column_product_name)),
                    ...
                    result.getString(result.getColumnIndex(column_latitude)),result.getString(result.getColumnIndex(column_longitude)));
        }
    ...
    public boolean insertProduct(Integer id, String column_product_name, String column_product_desc,
                                 String column_product_price, String column_latitude, String column_longitude)
    {
